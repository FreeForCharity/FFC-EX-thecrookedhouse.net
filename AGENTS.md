# AI Agent Instructions: FFC-EX-thecrookedhouse.net
...
These sites deploy to `https://freeforcharity.github.io/FFC-EX-thecrookedhouse.net/` and optionally to a custom domain if one is configured for this repo.
