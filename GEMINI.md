# Gemini Instructions: FFC-EX-thecrookedhouse.net

Hey Gemini! Welcome to FFC-EX-thecrookedhouse.net.

**Project:** FFC-EX-thecrookedhouse.net -- a Free For Charity nonprofit website for thecrookedhouse.net
...
The site deploys to `https://freeforcharity.github.io/FFC-EX-thecrookedhouse.net/` (and your custom domain if configured). The `assetPath()` function from `src/lib/assetPath.ts` handles this automatically.
